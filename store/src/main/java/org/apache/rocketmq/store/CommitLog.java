...
import org.apache.rocketmq.store.schedule.ArbitraryDelayScheduleMessageService;
...
public class CommitLog {
    ...
    private ArbitraryDelayScheduleMessageService arbitraryDelayScheduleMessageService;
    ...
    public CommitLog(final DefaultMessageStore defaultMessageStore) {
        ...
        this.arbitraryDelayScheduleMessageService = new ArbitraryDelayScheduleMessageService(defaultMessageStore);
    }
    ...
    public PutMessageResult putMessages(final MessageExtBatch messageExtBatch) {
        ...
        try {
            ...
            String delayTime = messageExtBatch.getProperties().get("delayTime");
            if ( (MessageExt) messageExtBatch  instanceof MessageExtBrokerInner && UtilAll.isNumeric(delayTime)){
                MessageExt messageExt = messageExtBatch;
                result = arbitraryDelayScheduleMessageService.appendMessage((MessageExtBrokerInner) messageExt);
            }else{
